  ...
  return (
    <main className="flex flex-col items-center p-8 min-h-screen bg-gray-50">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-2xl text-center mt-24">
        <Image src={libro.imagen} alt={libro.titulo} width={250} height={350} className="rounded-lg mx-auto mb-6" />
        ...
        <button onClick={handleAgregar} className="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700">
          Agregar al carrito
        </button>

        <button onClick={() => router.push("/libros")} className="ml-4 bg-gray-300 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-400">
          Volver
        </button>
      </div>
    </main>
